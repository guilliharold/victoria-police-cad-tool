...
A web-based tool for generating semi-realistic Victoria Police CAD lineups for use in [MissionChief-Australia](https://www.missionchief-australia.com/) and similar emergency services simulation games. Built to reflect real Victoria Police operational structure, callsign numbering conventions, and station hierarchy.
